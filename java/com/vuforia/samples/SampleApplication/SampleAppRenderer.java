...
public class SampleAppRenderer {
    ...
    // chamada quando as dimensoes da tela sao alteradas
    ...
    public void renderVideoBackground()
    {
        ...
        // atualiza a textura de fundo do video
        ...
        float[] vbProjectionMatrix = Tool.convert2GLMatrix( mRenderingPrimitives
                .getVideoBackgroundProjectionMatrix(currentView, COORDINATE_SYSTEM_TYPE.COORDINATE_SYSTEM_CAMERA)).getData();
