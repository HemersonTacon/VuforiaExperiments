...
public class SampleApplicationSession implements UpdateCallbackInterface
{
    ...
    public void initAR(Activity activity, int screenOrientation)
    {
        ...
        if (vuforiaException == null)
        {
            try
            {
                ...
                // aqui eh que realmente a vuforia eh inicializada
    ...
    public void startAR(int camera) throws SampleApplicationException
    {
        ...
        mCameraRunning = true;
        // tenta settar o foco da camera para CONTINUOUSAUTO: Lets you turn on driver-level
        // continuous autofocus for cameras. This mode is optimal for AR applications.
        // This mode yields the best tracking results because it guarantees that the camera
        // is focused on the target. (starts in Android 2.3 and iOS devices)
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            synchronized (mShutdownLock)
            {
                Vuforia.setInitParameters(mActivity, mVuforiaFlags, "");
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            if (result)
            {
                ...
                // inicializa o gerenciador de trackers e um image tracker
                ...
                if (initTrackersResult)
                {
                    try
                    {
                        ...
                        // inicializa a base de dados do tracker
                    ...
                    } catch (Exception e)
                    {
                        ...
                        // sendo este bem sucedido ou nao
                        mSessionControl.onInitARDone(vuforiaException);
                    }
