...
public class SampleUtils
{
    ...
    // compila o codigo do shader e verifica se a compilacao foi bem sucedida
    ...
    // cria e compila os shaders, cria um OpenGL ES program object, atrela os shaders a ele e o
    // compila (link), e por fim retorna o programa criado
    public static int createProgramFromShaderSrc(String vertexShaderSrc,
        String fragmentShaderSrc)
    {
        // compila os codigos de shader e verifica se a mesma foi bem sucedida
        ...
        if (vertShader == 0 || fragShader == 0)
            return 0;
        // cria um OpenGL ES program object vazio
        ...
        if (program != 0)
        {
            ...
            // cria um OpenGL ES program executavel
            GLES20.glLinkProgram(program);
            int[] glStatusVar = { GLES20.GL_FALSE };
            GLES20.glGetProgramiv(program, GLES20.GL_LINK_STATUS, glStatusVar,
                0);
            // verifica se a linkagem deu certo ou errado
            if (glStatusVar[0] == GLES20.GL_FALSE)
            {
                Log.e(
                    LOGTAG,
